...
namespace Ch16_AddressBook
{
    ...
    public class AddressBook
    {
        ...
        public List<Contact> Contacts { get; set; } //note to self: get&/or set here makes this a property
        // todo: make AddContact method to add contacts to address book
        //todo: what does void mean/do here?
        public AddressBook(string name) //! you ned a return type, and it wwill work! try this video @ 11min in: https://www.youtube.com/watch?v=ArrHTifOY20
        {
